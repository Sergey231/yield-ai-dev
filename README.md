...
### Core Functionality
- **Multi-Protocol Support**: Connect and manage positions across **14+** integrated Aptos DeFi protocols (plus Solana positions where applicable)
...
### Token list maintenance (Panora)

This repo keeps a cached Panora token list in `src/lib/data/tokenList.json`.
To refresh it, see `docs/panora-token-list.md`.
